...
const RenderContent = ({ data, exercise }) => {
  ...
  if (data.component === "image") {
    return (
      <div style={{width: '552px', margin:'30px 0', display: 'flex', alignItems:'center', justifyContent:'center'}}><img className={classes.contentImage} src={data.value} alt="content" /></div>
    );
  }
